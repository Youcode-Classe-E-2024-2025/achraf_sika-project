...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <?php
        session_start();
        define('BASE_URL', 'http://localhost/project_oop');
        ...
        ?>
        <form id="loginForm" class="space-y-4" action="<?= BASE_URL?>/controller/UserController.php?action=login" method="POST">
            <div>
        ...
        <div class="mt-4 text-center text-sm">
            ...
            <a href="..\signup\signup.html" class="text-indigo-600 hover:text-indigo-500">Sign up</a>
        </div>
    </div>
</body>
</html>